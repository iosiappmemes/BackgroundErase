...
extension UIImage {
    ...
    public func coarseSegmentation() -> CGImage? {
        ...
        //input size 513*513
        let pixBuf = self.pixelDeepBuffering(width: 513, height: 513)
...
extension UIImage {
  ...
  public func pixelDeepBuffering(width: Int, height: Int) -> CVPixelBuffer? {
    return pixelDeep(width: width, height: height,
                       pixelFormatType: kCVPixelFormatType_32ARGB,
                       colorSpace: CGColorSpaceCreateDeviceRGB(),
                       alphaInfo: .noneSkipFirst)
  }
 
  func pixelDeep(width: Int, height: Int, pixelFormatType: OSType,
